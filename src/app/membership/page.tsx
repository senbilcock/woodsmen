      ...
      <header className="relative py-32 md:py-40 overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6">
          ...
          <h1 className="font-display text-[clamp(2.5rem,6vw,4.5rem)] leading-[1] tracking-tight text-sand max-w-lg">
            Free With Your Alpine Gym Membership.
          </h1>
          <p className="text-sand-muted text-lg mt-4 max-w-lg">
            No separate fees. All equipment included. Just show up and work.
          </p>
        </div>
      </header>
      ...
      <section className="py-20 md:py-28 bg-night">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <h2 className="font-display text-[clamp(1.6rem,4vw,2.4rem)] tracking-tight text-sand text-center mt-2">
            Already an Alpine Gym Member? You&apos;re Already In.
          </h2>
          <p className="text-sand-muted text-center max-w-xl mx-auto mt-4">
            Woodsmen sessions are included with your QLDC Alpine Gym membership at no extra cost. Not a member yet? Sign up at the Alpine Gym and Woodsmen comes with it.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12 max-w-3xl mx-auto">
            <JoinStep num="1" title="Get Alpine Gym Membership" desc="Sign up at QLDC Alpine Gym. Woodsmen is automatically included." />
            <JoinStep num="2" title="Register for Sessions" desc="Drop your details below and we'll get you booked into your first session." />
