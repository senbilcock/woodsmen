...
const faqs = [
  ...
  { q: "How much does it cost?", a: "It's free. The council would pay contractors to clear wilding pines — you do that work as your workout, so the value of your labour funds the programme. All you need is a QLDC Alpine Gym membership." },
